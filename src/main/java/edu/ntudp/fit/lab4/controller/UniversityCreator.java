...
public class UniversityCreator {
    ...
    public University createTypicalUniversity() {
        ...
        Human secondHuman= humanCreate.createHuman("Tereshchenko", "Nastya", "Sergeevna", Sex.FEMALE);
        ...
        Student secondStudent = studentCreate.createStudent(secondHuman);
        ...
        Group firstroup = createGroup("122-21-sk", secondHuman, firstStudent, secondStudent, thirdStudent);
